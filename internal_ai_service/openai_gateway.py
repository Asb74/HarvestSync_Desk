...
class OpenAIGateway:
    ...
    def fallback_analisis_calibres_completo_prompt(context: str) -> str:
        return (
            ...
            "- Si hay pocos frutos medidos por CV, usa esos datos solo como orientación y completa la estimación con análisis visual apoyado en el patrón físico y los rangos de calibres.\n"
            "- Si escala_fisica_fiable=false, la estimación puede hacerse, pero con menor confianza y advertencia.\n"
            "- No marques apta_para_estimacion=false solo por tener pocos frutos medidos por CV.\n"
    ...
    def _fallback_prompt(task: str, context: str) -> str:
        ...
        if task == "estimacion_calibres":
            return (
                ...
                "Si hay pocos frutos medidos por CV, usa esos datos solo como orientación y completa la estimación "
                "con análisis visual apoyado en el patrón físico y los rangos de calibres.\n"
                "No marques apta_para_estimacion=false solo por tener pocos frutos medidos por CV.\n"
            ...
            seed_rows = [
                (
                    ...
                    (
                        ...
                        "- si hay pocos frutos medidos por CV, úsalos como guía y completa con interpretación visual "
                        "apoyada en patrón físico y rangos de calibres.\n"
                ...
                (
                    ...
                    (
                        ...
                        "Si hay pocos frutos medidos por CV, úsalos solo como orientación y completa con análisis visual "
                        "apoyado en patrón físico/rangos.\n"
                ...
                (
                    ...
                    (
                        ...
                        "Si hay pocos frutos medidos por CV, úsalos solo como guía y completa con interpretación visual "
                        "apoyada en patrón físico y rangos.\n"
