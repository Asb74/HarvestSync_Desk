...
fecha_desde = DateEntry(frame_filtros, width=12, background='darkblue', foreground='white', borderwidth=2)
fecha_desde.grid(row=1, column=len(campos))

tk.Label(frame_filtros, text="Hasta").grid(row=0, column=len(campos)+1)
fecha_hasta = DateEntry(frame_filtros, width=12, background='darkblue', foreground='white', borderwidth=2)
